...
!function(a) {
    ...
    var b = function(b) {
        ...
        var c = this
          , d = {
            getValue: function() {
                ...
                return console.log("The value of " + h + " is : ", b),
                b
            },
            $container: function() {
          ...
          , e = {
            show: function() {
                d.$container().show("slow"),
                d.trigger("logic:show")
            },
            hide: function() {
                d.$container().hide("slow"),
                d.trigger("logic:hide")
            },
            jumpTo: function() {
                try {
                    a.scrollTo(d.$container(), 800),
                    d.$field().focus()
                } catch (b) {}
                d.trigger("logic:jumpTo")
            },
            _disable: function(a) {
                a.addClass("jf-disabled"),
                a.find(":input").prop("disabled", !0).addClass("tmp-disabled")
            },
            disable: function() {
            ...
            _enable: function(a) {
                a.removeClass("jf-disabled"),
                a.find(":input.tmp-disabled").prop("disabled", !1).removeClass("tmp-disabled")
            },
            enable: function() {
                d.$container().each(function() {
                    e._enable(a(this))
            ...
            requiredDepends: function(b) {
                b ? d.$container().addClass("required") : d.$container().removeClass("required"),
                d.$field().each(function() {
                    var c = a(this);
                    c.rules("add", {
                        required: {
                            depends: function() {
      ...
      , c = function(c) {
        this.disabled = c && c.disabled || !1,
        this.selector = c && c.selector || "",
        this.condition = c && c.condition || "",
        this.value = c && c.value || "";
        var d = this
          , e = !1
          , f = new b(d.selector)
          , g = function(b) {
            var c = a.trim(f.value).toLowerCase()
              ...
              , g = a.isArray(f.value)
              , h = -1 !== a.inArray(d.value, f.value);
            switch (console.log("fieldValue = ", c, "selfValue = ", e, b),
            b) {
            case "==":
                return g ? h : c == e;
            case "!=":
      ...
      , d = function(a) {
        this.disabled = a && a.disabled || !1,
        this.action = a && a.action || "",
        this.selector = a && a.selector || "",
        this.match = a && a.match || "",
        this.rules = a && a.rules || [];
        var d = this
          , e = !1
          , f = new b(d.selector)
          , g = (f.$field,
        ...
        [])
          , h = {
            all: function() {
                for (var a = !0, b = 0, c = g.length; c > b; b++)
                    a = a && g[b].isValid();
                return a
            },
            any: function() {
          ...
          , k = function() {
            if (d.disabled)
                return console.log("ignore disabled logic"),
                !0;
            for (var a = 0, b = g.length; b > a; a++)
                g[a].validate();
            l()
          ...
          , l = function() {
            return e = h[d.match](),
            console.log("going to " + d.action + " " + d.selector),
            i[d.action](e),
            e
        };
        j(),
      ...
      , e = function(a) {
        ...
        var b = this
          ...
          , e = function() {
            ...
            for (c = [],
            a = 0,
            e = b.logics.length; e > a; a++)
                f = new d(b.logics[a]),
                f.disabled || c.push(f)
        }
          , f = function() {
            e(),
            console.log("Logics", c);
...
function(a) {
    var b, c, d = 1, e = a(".actions li.previous"), f = a(".actions li.next"), g = a(".actions .previous > a"), h = a(".actions .next > a"), i = a(".actions .numberText > label"), j = a("div.submit"), k = a(".stepBar .progress-bar"), l = k.find("label"), m = progressDefaultText = l.text(), n = function(a) {
        ...
        if (!(1 > c || c > b)) {
            d = c;
            var e = v(d);
            m = "" == e.progressText ? progressDefaultText : e.progressText,
            a(".steps li").removeClass("current"),
            e.$e.addClass("current"),
            g.text(n(e.labelPrevious)),
            h.text(n(e.labelNext)),
            i.text(n(e.labelNumberText)),
            a("section.page").removeClass("current").hide(),
            a("section.page:eq(" + (d - 1) + ")").addClass("current").show("slow"),
            s(),
            t()
        }
    }, s = function() {
        ...
        c.text(e),
        k.css("width", a).attr("aria-valuenow", a)
    }, u = function(a) {
        ...
        0 != a(".steps").length && (b = a(".steps > li").length,
        o(1),
        g.click(function(a) {
        ...
        function b(b, c) {
            if (c.hasClass("page")) {
                ...
                switch (b) {
                case "logic:show":
                    e.data("pageHidden", !1).attr("data-page-hidden", !1),
                    e.show("slow");
                    break;
                case "logic:hide":
                    e.data("pageHidden", !0).attr("data-page-hidden", !0),
                    e.hide("slow");
                    break;
                case "logic:jumpTo":
                    x() && (e.show("slow"),
    ...
    ,
    a.fn.formSteps.init = A,
    a.fn.formSteps.getStep = v,
    a.fn.formSteps.gotoStep = o
}(jQuery),
$("body").formSteps("init"),
function(a) {
    function b(b, c) {
            ...
            var d = !1
              , e = function() {
                if (!d) {
                    ...
                    b.each(function(b, c) {
                        var d, f = a(c), g = f[0];
                        return !g.complete || "undefined" != typeof g.naturalWidth && 0 == g.naturalWidth ? !1 : (f.data("origwidth") || f.data("origwidth", g.naturalWidth),
                        d = f.data("origwidth") > e - 40 ? "100%" : f.data("origwidth") + "px",
                        void f.css("width", d))
                    }),
                    d = !1
                }
...
function(a) {
    function b(a, b, c, d) {
        d = parseFloat(d),
        d = isNaN(d) ? 0 : d,
        a instanceof Date && b instanceof Date ? (a = a.getTime(),
        b = b.getTime(),
        d = 864e5 * d) : (a = parseFloat(a),
        a = isNaN(a) ? 0 : a,
        b = parseFloat(b),
        b = isNaN(b) ? 0 : b);
        var e;
    ...
    jQuery.validator.addMethod("compareTo", function(c, d) {
        var e = !0
          ...
          , k = f.val()
          , l = a(g).val();
        return "" == l ? !0 : ("date" == j && (k = new Date(k),
        l = new Date(l)),
        e = b(k, l, h, i))
...
function() {
    function a() {
        ...
        if (-1 !== b) {
            var c = window.location.href.slice(b + 1)
              , d = deparam(c);
            $.each(d, function(b, c) {
                try {
                    $("#" + b + ',[name="' + b + '"],[name="' + b + '[]"]').each(function() {
                        var b = $(this)
                          , d = b.val();
                        switch (!0) {
                        case b.is(":checkbox"):
                        case b.is(":radio"):
                            if (d == c || -1 !== $.inArray(d, c)) {
                                b.prop("checked", !0);
                                try {
                                    b.iCheck("update")
                                } catch (e) {}
                            ...
                            break;
                        case b.is("select"):
                            b.select2 ? b.select2("val", c) : b.val(c);
                            break;
                        default:
                            b.val(c)
                        }
    ...
    function d() {
        var a = function() {
            ...
            c.each(function() {
                var b = $(this).attr("id") + "_box"
                  , c = $("#" + b);
                $(this).is(":checked") && c.show(),
                a.attr("id") + "_box" == b && c.focus()
            })
        };
        $(".jf-form").on({
            click: a,
        ...
        $(".jf-option-box").blur(function() {
            var a = String($(this).attr("id")).replace("_box", "");
            "" == $.trim($(this).val()) && $("#" + a).attr("checked", !1),
            $("#" + a).val($(this).val()).trigger("change")
        })
    }
    function e() {
        ...
        $(c).length ? $(c).prop("href", "http://www.jqueryform.com").text("Powered by jqueryform.com") : $(decodeURIComponent(a)).appendTo($(b + "form")),
        $(c).show()
    }
    function f(a) {
        var b = function(b) {
            ...
            c.closest("div.form-group").addClass("bg-info has-error" + (d ? " has-feedback" : "")),
            c.is(":visible") && d && !c.data("glyphicon") && ($('<span class="glyphicon glyphicon-warning-sign form-control-feedback" aria-hidden="true"></span>').insertAfter(c),
            c.data("glyphicon", !0),
            setTimeout(function() {
                var a, b = c.height(), d = c.width();
                switch (!0) {
                case e.length >= 1:
            ...
            g($.Event("invalid-form"), $(a).data("validator"))
        }
          , c = function(b) {
            $(b).data("glyphicon", !1),
            $(b).closest("div.form-group").removeClass("bg-info has-error has-feedback").find("span.glyphicon,p.validation-error").remove(),
            g($.Event("invalid-form"), $(a).data("validator"))
        };
        ...
        var d = function(a, b) {
          ...
          , f = function() {
            var a, b = $("#g-recaptcha").data("size"), c = function() {
                var a = function() {
                ...
                $("#g-recaptcha-response").length && ($("#g-recaptcha-response").valid(),
                a = !0)
            };
            return {
                init: c,
          ...
          , g = function(a, b) {
            ...
            c && ($("p.error").show(),
            f.checkRequired()),
            c = b.numberOfInvalids(),
            c || $("p.error").hasClass("server-error") || $("p.error").hide()
        }
          , h = {}
          , i = function(a) {
          ...
          , j = function(a) {
            ...
            if (b.length) {
                ...
                a && a.serverRedirect && (c = a.serverRedirect);
                var d = i(b.html());
                b.html(d);
                var e = function() {
                    if (parent) {
                        var a = ($("body > *:visible").height(),
                        $(window.parent.document).find('iframe[src*="' + location.pathname + '"]'));
                ...
                if ("" === c)
                    return b.show("slow"),
                    void setTimeout(e, 500);
                var f = parseInt(b.data("seconds"));
                a && a["serverRedirect.setTimeout"] && (f = a["serverRedirect.setTimeout"]),
                f > 0 ? (b.show("slow"),
                setTimeout(e, 500)) : f = 0,
                setTimeout(function() {
                    c = i(c);
                    try {
          ...
          , k = function() {
            var a, b = $(".submit > button"), c = $(".submit div.progress");
            a = {
                width: b.outerWidth(),
          ...
          , l = function(a) {
            if (null === location.href.match(/^https*/) && null === $(a).attr("action").match(/^https*/))
                return $("h4.local-submit").length || $("<h4 style='padding:16px;' class='bg-info local-submit'>Form submit does not work on local computer.<br>Please test it on your web server!</h4>").appendTo($(".jf-form")),
                !1;
            ...
            $("#serverValidationFields").val(c.join(",")),
            b.removeClass("server-error"),
            $btn = new k,
            $btn.showProgressBar();
            var d = function() {
                var c = $(a).ajaxSubmit()
                ...
                d.done(function(a) {
                    ...
                    data && data.validated === !0 ? ($(".jf-form").hide(),
                    h = data.fieldValues,
                    j(h)) : (c && b.text(a),
                    b.addClass("server-error").show("slow"),
                    $btn.hideProgressBar(),
                    setTimeout(function() {
                        b.html(b.data("origMsg")),
                        b.hide()
                    }, 5e3))
                })
            };
        ...
        var m = function() {
            var a = $(this);
            return a.hasClass("g-recaptcha-response") && !$("#g-recaptcha").is(":hidden") ? !1 : (yes = a.is(":hidden") || a.is(":input.tmp-disabled"),
            yes)
        }
          , n = 0 === String($(a).data("licensekey")).toUpperCase().indexOf("JF-");
        n ? $(".jf-copyright").remove() : (e(),
        setInterval(e, 1e4)),
        $(a).validate({
    ...
    function g(a) {
        ...
        $(a).each(function(a, b) {
            ...
            $.each(["format", "weekStart", "startDate", "endDate", "startView", "minViewMode", "todayBtn", "clearBtn", "language", "orientation", "multidate", "multidateSeparator", "daysOfWeekDisabled", "calendarWeeks", "autoclose", "todayHighlight", "datesDisabled", "toggleActive", "defaultViewDate"], function(a, b) {
                if (c = e.data("datepicker-" + b.toLowerCase()))
                    switch (b) {
                    case "datesDisabled":
                        d[b] = String(c).split(",");
                        break;
    ...
    function h() {
        $("input[type=file].form-control").each(function(a, b) {
            ...
            i > 0 && (c.maxFileCount = i),
            g || (c.maxFileCount = 1),
            h && (c.browseLabel = h),
            f && (c.allowedFileExtensions = String(f).replace(/\s+/g, "").split(",")),
            j && (c.maxFileSize = parseFloat(String(j))),
            "undefined" != typeof fileinputLanguage && (c.language = fileinputLanguage);
    ...
    i.init = function(e) {
        ...
        b(e),
        a(),
        $(document).trigger("JF.ready", {
            formId: e
        }),
        $.setResponsiveToImages($(e).find("img"))
    }
    ,
    $.formlogic && $.formlogic.field && (i.field = $.formlogic.field),
    window.JF = i
}(),
function() {
    function a(a, b) {
        for (var c, d = [], e = !1, f = !1, a = String(a).toLowerCase(), g = 0, h = b.length; h > g; g++) {
            c = b[g],
            ("undefined" == typeof c.value || "" == $.trim(c.value) || "null" == $.trim(c.value) || "undefined" == $.trim(c.value)) && (c.value = c.label);
            var i = "#depend" == c.label;
            if (i && String(c.value).toLowerCase() == a)
                e = !0;
            else {
